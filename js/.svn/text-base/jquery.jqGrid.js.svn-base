...
(function (b) {
    ...
    b.extend(b.jgrid, {
        ...
        parseDate: function (f, j) {
            ...
            if (j && j !== null && j !== undefined) {
                ...
                j = j.split(/[\\\/:_;.\t\T\s-]/);
                f = f.split(/[\\\/:_;.\t\T\s-]/);
                var m = b.jgrid.formatter.date.monthNames,
        ...
        from: function (f) {
            return new(function (j, i) {
                ...
                this._getOrder = function (n, l, p, A, t) {
                    ...
                    fa = A == "float" || A == "number" || A == "currency" || A == "numeric" ?
                    function (P) {
                ...
                this.contains = function (n, l) {
                    M ? c._append(c._getStr("this." + n) + '.indexOf("' + c._toStr(l) + '",0) > -1') : c._append(c._getStr("this") + '.indexOf("' + c._toStr(n) + '",0) > -1');
                ...
                var c = b.extend(true, {
                    ...
                    e = {
                        ...
                        populateVisible: function () {
                            ...
                            if (d) {
                                ...
                                if (h) {
                                    e.prevRowHeight = h;
                                    var q = c.rowNum,
                                        o = e.scrollTop = e.bDiv.scrollTop,
                                        x = Math.round(g.position().top) - o,
                                        w = x + g.height();
                                    h = h * q;
                                    var C, D, s;
                                    if (w < d && x <= 0 && (c.lastpage === undefined || parseInt((w + o + h - 1) / h, 10) <= c.lastpage)) {
                        ...
                        selectionPreserver: function (d) {
                            var g = d.p,
                                h = g.selrow,
                                q = g.selarrrow ? b.makeArray(g.selarrrow) : null,
                                o = d.grid.bDiv.scrollLeft,
                                x = g.gridComplete;
                            g.gridComplete = function () {
                                g.selrow = null;
                                g.selarrrow = [];
                                if (g.multiselect && q && q.length > 0) for (var w = 0; w < q.length; w++) q[w] != h && b(d).jqGrid("setSelection", q[w], false);
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var J = function (d, g) {
                            ...
                            t = function (d, g, h, q) {
                                ...
                                return '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + M(d, g, "") + ">" + h + "</td>"
                            },
                            H = function (d) {
                                var g, h = [],
                                    q = 0,
                            ...
                            fa = function (d, g, h, q, o) {
                                var x = new Date,
                                    ...
                                    C, D = a.p.datatype == "local" ? "local" : "xml";
                                if (w) {
                                    a.p.data = [];
                                    a.p._index = {};
                                ...
                                if (b.isXMLDoc(d)) {
                                    ...
                                    var s, v = 0,
                                        ...
                                        W, S = {},
                                        N, L, X = [],
                                        oa = a.p.altRows === true ? " " + a.p.altclass : "";
                                    a.p.xmlReader.repeatitems || (U = H(D));
                                    z = a.p.keyIndex === false ? a.p.xmlReader.id : a.p.keyIndex;
                                    if (U.length > 0 && !isNaN(z)) {
                                        if (a.p.remapColumns && a.p.remapColumns.length) z = b.inArray(z, a.p.remapColumns);
                                        z = U[z]
                                    }
                                    D = (z + "").indexOf("[") === -1 ? U.length ?
                                    function (da, Z) {
                                    ...
                                    var ga = d.length,
                                        $ = 0;
                                    if (d && ga) {
                                        var ha = parseInt(a.p.rowNum, 10),
                                            ra = a.p.scroll ? (parseInt(a.p.page, 10) - 1) * ha + 1 : 1;
                                        if (o) ha *= o + 1;
                            ...
                            ca = function (d, g, h, q, o) {
                                ...
                                if (d) {
                                    ...
                                    W = S.length;
                                    d = 0;
                                    var oa = parseInt(a.p.rowNum, 10),
                                        ga = a.p.scroll ? (parseInt(a.p.page, 10) - 1) * oa + 1 : 1;
                                    if (o) oa *= o + 1;
                                    ...
                                    if (a.p.treeGrid) b(a).jqGrid("SortTree", d, a.p.sortorder, h[d].stype, h[d].srcfmt);
                                        ...
                                        if (a.p.search === true) {
                                            var v = a.p.postData.filters,
                                                y;
                                            if (v) {
                                                if (typeof v == "string") v = b.jgrid.parse(v);
                        ...
                        u = function (d, g) {
                            var h = "",
                                q = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",
                                o = "",
                                x, w, C, D, s = function (v) {
                                    var y;
                            ...
                            if (m == "rtl") q += o;
                            if (a.p.pginput === true) h = "<td dir='" + m + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1'></span>") + "</td>";
                            ...
                            if (m == "ltr") q += o;
                            q += "</tr></tbody></table>";
                            a.p.viewrecords === true && b("td#" + d + "_" + a.p.recordpos, "#" + x).append("<div dir='" + m + "' style='text-align:" + a.p.recordpos + "' class='ui-paging-info'></div>");
                        ...
                        var Ca = function (d, g, h, q) {
                            ...
                            Ga = function (d) {
                                var g, h = {},
                                    q = G ? 0 : a.p.cellLayout;
                                for (g = h[0] = h[1] = h[2] = 0; g <= d; g++) if (a.p.colModel[g].hidden === false) h[0] += a.p.colModel[g].width + q;
    ...
    b.jgrid.extend({
                ...
                for (; k < e;) {
                    ...
                    if (b(r).hasClass("jqgrow")) {
                        b("td", r).each(function (u) {
                            ...
                            if (a !== "cb" && a !== "subgrid" && a !== "rn") if (m.p.treeGrid === true && a == m.p.ExpandColumn) j[a] = b.jgrid.htmlDecode(b("span:first", this).html());
                            else
                            try {
                                j[a] = b.unformat(this, {
                                    rowId: r.id,
        ...
        addRowData: function (f, j, i, c) {
            ...
            if (j) {
                ...
                this.each(function () {
                    ...
                    if (t.p.altRows === true && !M) if (i == "last")(t.rows.length - 1) % 2 == 1 && b(t.rows[t.rows.length - 1]).addClass(l);
                    else b(t.rows).each(function (P) {
        ...
        footerData: function (f, j, i) {
            function c(r) {
                for (var u in r) if (r.hasOwnProperty(u)) return false;
                return true
            }
            var e, k = false,
                m = {},
...
(function (c) {
    ...
    c.fn.fmatter.date = function (a, b, d, e) {
        d = c.extend({}, b.date);
        c.fmatter.isUndefined(b.colModel.formatoptions) || (d = c.extend({}, d, b.colModel.formatoptions));
        return !d.reformatAfterEdit && e == "edit" ? c.fn.fmatter.defaultFormat(a, b) : c.fmatter.isEmpty(a) ? c.fn.fmatter.defaultFormat(a, b) : c.fmatter.util.DateFormat(d.srcformat, a, d.newformat, d)
    };
    ...
    c.fn.fmatter.actions = function (a, b) {
        ...
        if (a.editbutton) {
            h = "onclick=$.fn.fmatter.rowactions('" + d + "','" + b.gid + "','edit'," + a.keys + ");";
        ...
        h = "onclick=$.fn.fmatter.rowactions('" + d + "','" + b.gid + "','save',false);";
    ...
    c.unformat = function (a, b, d, e) {
        var h, g = b.colModel.formatter,
            ...
            i = /([\.\*\_\'\(\)\{\}\+\?\\])/g,
            j = b.colModel.unformat || c.fn.fmatter[g] && c.fn.fmatter[g].unformat;
...
function createEl(a, b, c, e, f) {
        ...
        if (typeof b.dataUrl != "undefined") jQuery.ajax(jQuery.extend({
            ...
            if (typeof b.value === "string") {
                ...
                for (h in e) if (e.hasOwnProperty(h)) {
                    ...
                    a.value = h;
                    a.innerHTML = e[h];
                    if (!j && (jQuery.trim(h) == jQuery.trim(c) || jQuery.trim(e[h]) == jQuery.trim(c))) a.selected = "selected";
    ...
    case "custom":
        ...
        try {
            ...
            n == "e2" ? info_dialog(jQuery.jgrid.errors.errcap, "function 'custom_element' " + jQuery.jgrid.edit.msg.novalue, jQuery.jgrid.edit.bClose) : info_dialog(jQuery.jgrid.errors.errcap, typeof n === "string" ? n : n.message, jQuery.jgrid.edit.bClose)
        }
        break
    }
    return d
...
function checkValues(a, b, c) {
    ...
    if (e) {
        ...
        if (e.date === true) if (!(f === false && isEmpty(a))) {
            ...
            if (!checkDate(b, a)) return [false, g + ": " + jQuery.jgrid.edit.msg.date + " - " + b, ""]
        }
    ...
    a.jgrid.extend({
        searchGrid: function (f) {
            ...
            return this.each(function () {
                ...
                function o(m) {
                    ...
                    m.hide();
                    f.overlay === true && a(".jqgrid-overlay:first", "#gbox_" + w.p.id).hide()
                }
                function C() {
                ...
                function B(m) {
                    ...
                    var q = a("#" + w.p.id),
                        A = {};
                    q[0].p.search = false;
                    if (f.multipleSearch === false) A[f.sField] = A[f.sValue] = A[f.sOper] = "";
                    else A[f.sFilter] = "";
                ...
                if (w.grid) {
                    ...
                    if (a.fn.searchFilter) {
                        ...
                        if (a("#" + i).html() != null) {
                            ...
                            var n = [],
                                E = a("#" + w.p.id).jqGrid("getGridParam", "colNames"),
                                g = a("#" + w.p.id).jqGrid("getGridParam", "colModel"),
                                k = ["eq", "ne", "lt", "le", "gt", "ge", "bw", "bn", "in", "ni", "ew", "en", "cn", "nc"],
                                h, j, l, s = [];
                            ...
                            for (h = 0; h < k.length; h++) s[h] = {
                                op: k[h],
                                text: f.odata[h]
                            };
                            a.each(g, function (m, q) {
                                var A =
                                typeof q.search === "undefined" ? true : q.search,
                                    F = q.hidden === true;
                                m = a.extend({}, {
                                    text: E[m],
                            ...
                            if (n.length > 0) {
                                ...
                                if (f.drag === true) {
                                    ...
                                    if (jQuery.fn.jqDrag) a("#" + i).jqDrag(a("#" + i + " table thead tr:first td:first"));
                                    else
                                    try {
                                        a("#" + i).draggable({
            ...
            return this.each(function () {
                ...
                function C(e, r, t, p) {
                    ...
                    a(r.p.colModel).each(function (T) {
                        ...
                        if (I !== "cb" && I !== "subgrid" && this.editable === true && I !== "rn") {
                            if (H === false) y = "";
                            else if (I == r.p.ExpandColumn && r.p.treeGrid === true) y = a("td:eq(" + T + ")", r.rows[H]).text();
                            else
                            try {
                            ...
                            var W = a.extend({}, this.editoptions || {}, {
                                ...
                                aa = parseInt(X.rowpos, 10) || J + 1,
                                ea = parseInt((parseInt(X.colpos, 10) || 1) * 2, 10);
                            if (e == "_empty" && W.defaultValue) y = a.isFunction(W.defaultValue) ? W.defaultValue() : W.defaultValue;
                            ...
                            if (X.rowabove) {
                                W = a("<tr><td class='contentinfo' colspan='" + p * 2 + "'>" + X.rowcontent + "</td></tr>");
                                a(t).append(W);
                                W[0].rp = aa
                            }
                            if (x.length === 0) {
                    ...
                    if (J > 0) {
                        S = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (p * 2 - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + r.p.id + "_id' value='" + e + "'/></td></tr>");
                        S[0].rp = J + 999;
                        a(t).append(S);
                        ...
                        a(G).each(function () {
                            ...
                            if (x[0] != null) {
                                ...
                                if (J.defaultValue) {
                                    ...
                                    y = a(x).attr("offval")
                                } else if (x[0].type && x[0].type.substr(0, 6) == "select") x[0].selectedIndex = 0;
                                else x.val(y);
                        ...
                        if (R) {
                            a("td", R).each(function (H) {
                                ...
                                if (p !== "cb" && p !== "subgrid" && p !== "rn" && G[H].editable === true) {
                                    if (p == r.p.ExpandColumn && r.p.treeGrid === true) z = a(this).text();
                                    else
                                    try {
                                        z = a.unformat(a(this), {
                                            rowId: e,
                                    ...
                                    case "checkbox":
                                        z += "";
                                        if (G[H].editoptions && G[H].editoptions.value) if (G[H].editoptions.value.split(":")[0] == z) {
                                    ...
                                    case "custom":
                                        try {
                                            if (G[H].editoptions && a.isFunction(G[H].editoptions.custom_value)) G[H].editoptions.custom_value(a("#" + p, "#" + t), "set", z);
                                            else
                                            throw "e1";
                                        } catch (T) {
                ...
                function B() {
                    ...
                    if (e[0] && !d.processing) {
                        ...
                        r = a.extend({
                            url: d.url ? d.url : a(g).jqGrid("getGridParam", "editurl"),
                            type: d.mtype,
                            ...
                            complete: function (J, y) {
                                ...
                                if (e[0] === false) {
                                    ...
                                    a.each(g.p.colModel, function () {
                                        if (u[this.name] && this.formatter && this.formatter == "select") try {
                                            delete u[this.name]
                                        } catch (R) {}
                                    });
                                    c = a.extend(c, u);
                                    ...
                                    if (c[I] == t.addoper) {
                                        ...
                                        if (d.closeAfterAdd) {
                                            ...
                                            d.reloadAfterSubmit ? a(g).trigger("reloadGrid") : a(g).jqGrid("addRowData", e[2], c, b.addedrow);
                                            v("_empty", g, h)
                ...
                if (g.grid && f) {
                    var k = g.p.id,
                        ...
                        s = a.isFunction(d.beforeShowForm) ? d.beforeShowForm : false,
                        Q = a.isFunction(d.afterShowForm) ? d.afterShowForm : false,
                        m = a.isFunction(d.beforeInitData) ? d.beforeInitData : false,
                        q = a.isFunction(d.onInitializeForm) ? d.onInitializeForm : false,
                        A = null,
                        F = 1,
                        K = 0,
                        c, u, M, U;
                    ...
                    b.recreateForm === true && a("#" + l.themodal).html() != null && a("#" + l.themodal).remove();
                    var O = true;
                    ...
                    if (a("#" + l.themodal).html() != null) {
                        ...
                        D = "<table border='0' class='EditTable' id='" + j + "_2'><tbody><tr id='Act_Buttons'><td class='navButton ui-widget-content'>" + (m ? V + D : D + V) + "</td><td class='EditButton ui-widget-content'>" + Z + $ + "</td></tr>";
                        ...
                        P = a("<span></span>").append(P).append(D); /*createModal(l,P,b,"#gview_"+g.p.id,a("#gbox_"+g.p.id)[0]);*/
                        if (m) {
                        ...
                        a("#pData", "#" + j + "_2").click(function () {
                            ...
                            var e = E();
                            if (e[0] != -1 && e[1][e[0] - 1]) {
                                a.isFunction(b.onclickPgButtons) && b.onclickPgButtons("prev", a("#" + h), e[1][e[0]]);
                                v(e[1][e[0] - 1], g, h);
                                a(g).jqGrid("setSelection", e[1][e[0] - 1]);
            ...
            return this.each(function () {
                ...
                function C(c, u, M, U) {
                    ...
                    a(u.p.colModel).each(function () {
                        ...
                        if (!P && this.align === "right") if (this.formatter && a.inArray(this.formatter, r) !== -1) t = Math.max(t, parseInt(this.width, 10));
                    ...
                    a(u.p.colModel).each(function (y) {
                        ...
                        if (O !== "cb" && O !== "subgrid" && O !== "rn" && x) {
                            ...
                            var L = a.extend({}, {
                                ...
                                G = parseInt(L.rowpos, 10) || D + 1,
                                R = parseInt((parseInt(L.colpos, 10) || 1) * 2, 10);
                            if (L.rowabove) {
                            ...
                            a("td:eq(" + (R - 1) + ")", N[0]).append("<span>" + V + "</span>").attr("id", "v_" + O);
                ...
                function v(c, u) {
                    ...
                    if (N = a(u).jqGrid("getInd", c, true)) {
                        a("td", N).each(function (D) {
                            ...
                            U = u.p.colModel[D].editrules && u.p.colModel[D].editrules.edithidden === true ? false : u.p.colModel[D].hidden === true ? true : false;
                ...
                if (i.grid && f) {
                    ...
                    if (a("#" + k.themodal).html() != null) {
                        ...
                        var l = isNaN(b.dataheight) ? b.dataheight : b.dataheight + "px",
                            s = a("<form name='FormPost' id='" + E + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + l + ";'></form>"),
                            Q = a("<table id='" + g + "' class='EditTable' cellspacing='1' cellpading='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                        a(s).append(Q);
                        C(f, i, Q, h);
                        l = i.p.direction == "rtl" ? true : false;
                        var m = "<a href='javascript:void(0)' id='" + (l ? "nData" : "pData") + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>",
                            q = "<a href='javascript:void(0)' id='" + (l ? "pData" : "nData") + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",
                            A = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + b.bClose + "</a>";
                        if (j > 0) {
                            var F = [];
                        ...
                        s = a("<span></span>").append(s).append("<table border='0' class='EditTable' id='" + g + "_2'><tbody><tr id='Act_Buttons'><td class='navButton ui-widget-content' width='" + b.labelswidth + "'>" + (l ? q + m : m + q) + "</td><td class='EditButton ui-widget-content'>" + A + "</td></tr></tbody></table>");
                        ...
                        a("#nData", "#" + g + "_2").click(function () {
                            ...
                            if (c[0] != -1 && c[1][c[0] + 1]) {
                                ...
                                a.isFunction(b.afterclickPgButtons) && b.afterclickPgButtons("next", a("#" + E), c[1][c[0] + 1]);
        ...
        delGridRow: function (f, b) {
            ...
            b = a.extend({
                ...
                beforeSubmit: null,
                onclickSubmit: null,
                afterSubmit: function(data, arr) { console.debug(data.responseText); var res11 = data.responseText.split(":"); return [(res11[0] == "true") ? true : false, res11[1]]; },
                jqModal: true,
                closeOnEscape: false,
                delData: {},
                delicon: [],
            ...
            return this.each(function () {
                var o = this;
                if (o.grid) if (f) {
                    var C = typeof b.beforeShowForm === "function" ? true : false,
                        v = typeof b.afterShowForm === "function" ? true : false,
                        B = o.p.id,
                        w = {},
                        i = "DelTbl_" + B,
                        n, E, g, k, h = {
                    ...
                    if (a("#" + h.themodal).html() != null) {
                        ...
                        j += "</tbody></table></div>";
                        j += "<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + i + "_2'><tbody><tr><td class='DataTD ui-widget-content'></td></tr><tr style='display:block;height:3px;'><td></td></tr><tr><td class='DelButton EditButton'>" + ("<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + b.bSubmit + "</a>") + "&#160;" + ("<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + b.bCancel + "</a>") + "</td></tr></tbody></table>";
                        b.gbox = "#gbox_" + B;
                        ...
                        if (b.cancelicon[0] === true) a("#eData", "#" + i + "_2").addClass(b.cancelicon[1] == "right" ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " + b.cancelicon[2] + "'></span>");
                        a("#dData", "#" + i + "_2").click(function () {
                            ...
                            if (l[0] && !d.processing) {
                                ...
                                n[E] = s;
                                var Q = a.extend({
                                    url: d.url ? d.url : a(o).jqGrid("getGridParam", "editurl"),
                                    type: b.mtype,
                                    ...
                                    complete: function (m, q) {
                                        ...
                                        if (l[0] === false) {
                                            ...
                                            if (d.reloadAfterSubmit && o.p.datatype != "local") {
                                                ...
                                                for (var F = 0; F < q.length; F++) a(o).jqGrid("delRowData", q[F]);
                                                o.p.selrow = null;
                                                o.p.selarrrow = [];
												
												//reload grid after deletion is done
												a(o).trigger("reloadGrid");
                                            }
                    ...
                    for (g = 0; g < E; g++) {
                        ...
                        if (b.add) {
                            ...
                            a(k, h).attr({
                                ...
                                a(this).hasClass("ui-state-disabled") || (typeof b.addfunc == "function" ? b.addfunc() : a(n).jqGrid("editGridRow", "new", C));
                                return false
                            }).hover(function () {
                        ...
                        if (b.view) {
                            k = a("<td class='ui-pg-button ui-corner-all'></td>");
                            w = w || {};
                            a(k).append("<div class='ui-pg-div'><span class='ui-icon " + b.viewicon + "'></span>" + b.viewtext + "</div>");
                            a("tr", h).append(k);
                            a(k, h).attr({
                                title: b.viewtitle || "",
                                id: w.id || "view_" + l
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    if (o) {
                        ...
                        if (b.position == "first") o.rows[0].cells.length === 0 ? a("tr", o).append(v) : a("tr td:eq(0)", o).before(v);
                        else a("tr", o).append(v);
            ...
            return this.each(function () {
                ...
                if (o.grid) {
                    ...
                    if (C) for (var v in C) a("[name=" + v + "]", b).is("input:radio") || a("[name=" + v + "]", b).is("input:checkbox") ? a("[name=" + v + "]", b).each(function () {
                        a(this).val() == C[v] ? a(this).attr("checked", "checked") : a(this).attr("checked", "")
                    }) : a("[name=" + v + "]", b).val(C[v])
                }
            })
        },
        FormToGrid: function (f, b, o, C) {
            return this.each(function () {
                ...
                if (v.grid) {
                    o || (o = "set");
                    C || (C = "first");
                    var B = a(b).serializeArray(),
                        w = {};
                    a.each(B, function (i, n) {
                        w[n.name] = n.value
                    });
                    if (o == "add") a(v).jqGrid("addRowData", f, w, C);
                    else o == "set" && a(v).jqGrid("setRowData", f, w)
                }
            })
        }
    })
            ...
            return this.each(function () {
                ...
                if (c !== null && (typeof c === "object" || f.isFunction(c))) if (c.groupField.length) {
                    for (var a = 0; a < c.groupField.length; a++) {
                        ...
                        c.groupColumnShow[a] === true ? f(b).jqGrid("showCol", c.groupField[a]) : f(b).jqGrid("hideCol", c.groupField[a]);
                        c.sortitems[a] = [];
                        c.sortnames[a] = [];
                        c.summaryval[a] = [];
                        if (c.groupSummary[a]) {
        ...
        groupingRender: function (b, c) {
            return this.each(function () {
                ...
                f.each(d.sortitems[0], function (h, k) {
                    ...
                    e += '<tr id="' + j + '" role="row" class= "ui-widget-content jqgroup ui-row-' + a.p.direction + '"><td colspan="' + c + '">' + g + f.jgrid.format(d.groupText[0], d.sortnames[0][h], b[k].length) + "</td></tr>";
    ...
    d.jgrid.extend({
            ...
            return this.each(function () {
                ...
                if (a.grid && a.p.treeGrid) {
                    var f = a.p.expColInd,
                        ...
                        j = a.p.treeReader.level_field;
                    c.level = b[j];
                    if (a.p.treeGridModel == "nested") {
                        var i = b[a.p.treeReader.left_field],
                            h = b[a.p.treeReader.right_field];
                    ...
                    i = "<div class='tree-wrap tree-wrap-" + a.p.direction + "' style='width:" + i * 18 + "px;'>";
                    ...
                    if (parseInt(b[j], 10) !== parseInt(a.p.tree_root_level, 10)) d(a).jqGrid("isVisibleNode", b) || d(c).css("display", "none");
                    ...
                    a.p.ExpandColClick === true && d("span", c).css("cursor", "pointer").bind("click", function (g) {
                        g = d(g.target || g.srcElement, a.rows).closest("tr.jqgrow")[0].id;
                        var l = a.p._index[g],
                            m = a.p.treeReader.expanded_field;
        ...
        getNodeParent: function (b) {
            ...
            this.each(function () {
                ...
                case "nested":
                    ...
                    break;
                case "adjacency":
                    var g = a.p.treeReader.parent_id_field,
                        l = a.p.localReader.id;
                    d(this.p.data).each(function () {
                        if (this[l] == b[g]) {
                            c = this;
                            return false
        ...
        getFullTreeNode: function (b) {
            ...
            this.each(function () {
                ...
                case "adjacency":
                    c.push(b);
                    var l = a.p.treeReader.parent_id_field,
        ...
        isVisibleNode: function (b) {
            ...
            this.each(function () {
                var a = this;
                if (a.grid && a.p.treeGrid) {
                    var f = d(a).jqGrid("getNodeAncestors", b),
                        e = a.p.treeReader.expanded_field;
                    d(f).each(function () {
                        c = c && this[e];
                        if (!c) return false
        ...
        columnChooser: function (b) {
            ...
            if (!a("#colchooser_" + g[0].p.id).length) {
                ...
                var h = g.jqGrid("getGridParam", "colModel"),
                    i = g.jqGrid("getGridParam", "colNames"),
                    l = {},
                    m = [];
                e.empty();
                a.each(h, function (f) {
